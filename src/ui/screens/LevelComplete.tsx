...
import { Ic, Waves, Crown, Sparkles, Trophy, Home } from '../components/icons';
    ...
    return (
      <div className="overlay" style={{ background: 'rgba(2,10,22,.55)' }}>
        <Panel className="panel strong center" style={{ padding: 34 }}>
          <div className="complete-stars"><Ic icon={Waves} size={26} color="var(--aqua)" /> <Ic icon={Crown} size={30} color="var(--gold)" /> <Ic icon={Waves} size={26} color="var(--aqua)" /></div>
          ...
          <div className="row" style={{ gap: 10 }}>
            <button className="btn primary block" onClick={() => { Audio.uiConfirm(); onMenu(); }}><Ic icon={Home} size={15} /> Back to Menu</button>
  ...
  return (
    <div className="overlay" style={{ background: 'rgba(2,10,22,.45)' }}>
      <Panel className="panel strong center" style={{ padding: 30 }}>
        <div className="complete-stars"><Ic icon={Sparkles} size={24} color="var(--gold)" /> <Ic icon={Trophy} size={30} color="var(--gold)" /> <Ic icon={Sparkles} size={24} color="var(--gold)" /></div>
